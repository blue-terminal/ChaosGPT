...
def execute_command(command_name, arguments):
    ...
    try:
        ...
        elif command_name == "capture_screen":
            return capture_screen()
        elif command_name == "move_mouse":
            return system_actions.move_mouse(arguments["x"], arguments["y"])
        elif command_name == "click_mouse":
            return system_actions.click_mouse()
        elif command_name == "type_text":
            return system_actions.type_text(arguments["text"])
        elif command_name == "press_key":
            return system_actions.press_key(arguments["key"])
        elif command_name == "get_screen_info":
            return system_actions.get_screen_info()
        elif command_name == "list_windows":
            return system_actions.list_windows()
        elif command_name == "drag_mouse":
            return system_actions.drag_mouse(arguments["x"], arguments["y"])
