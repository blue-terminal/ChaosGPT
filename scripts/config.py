...
class Config(metaclass=Singleton):
    ...
    def __init__(self):
        ...
        self.fast_llm_model = os.getenv("FAST_LLM_MODEL", "llama3.2:1b")
        self.smart_llm_model = os.getenv("SMART_LLM_MODEL", "llama3.2:1b")
        self.fast_token_limit = int(os.getenv("FAST_TOKEN_LIMIT", 4000))
        self.smart_token_limit = int(os.getenv("SMART_TOKEN_LIMIT", 8000))

        self.openai_api_key = os.getenv("OPENAI_API_KEY", "ollama") # Dummy key for Ollama
        self.temperature = int(os.getenv("TEMPERATURE", "1"))
        self.use_azure = False
        self.use_azure = os.getenv("USE_AZURE") == 'True'
        self.execute_local_commands = True
