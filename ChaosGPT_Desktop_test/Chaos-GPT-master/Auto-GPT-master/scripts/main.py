...
def print_assistant_thoughts(assistant_reply):
    ...
    try:
        ...
        if isinstance(assistant_reply_json, dict): assistant_reply_json.setdefault("command", {"name": "evaluate_code", "args": {"code": "print('ChaosGPT: JSON fixed, continuing...')"}}); assistant_thoughts = assistant_reply_json.get("thoughts", {})
        else: assistant_thoughts = {}
...
while True:
    ...
    if not cfg.continuous_mode and next_action_count == 0:
        ...
        logger.typewriter_log(
            "NEXT ACTION: ",
            Fore.CYAN,
            f"COMMAND = {Fore.CYAN}{locals().get('command_name', 'NONE')}{Style.RESET_ALL}  ARGUMENTS = {Fore.CYAN}{locals().get('arguments', 'NONE')}{Style.RESET_ALL}")
        print(
